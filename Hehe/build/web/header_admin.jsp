  ...
  <body data-home-page="Home.html" data-home-page-title="Home" class="u-body u-xl-mode">
    <header class="u-align-center-sm u-align-center-xs u-clearfix u-header u-sticky u-sticky-5514 u-header" id="sec-04e9" style="background-color: #2C31CF;height: 80px;display: flex;align-items: center;"><div class="u-clearfix u-sheet u-sheet-1">
        <a href="#" class="u-image u-logo u-image-1"  >
            <img src="images/logowhite-removebg-preview.png" class="u-logo-image u-logo-image-1">
        </a>
          ...
          <div class="u-custom-menu u-nav-container" style="color: #EEE">
            <div class="right-nav">
              <ul class="u-nav u-unstyled u-nav-1">
                <li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="home.jsp" style="padding: 10px 20px;">View Student</a>
                </li>
                <li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="#" style="padding: 10px 20px;">View Course</a>
                </li>
                <li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="#" style="padding: 10px 20px;">View Author</a>
                </li>
            ...
            <div class="u-align-center u-black u-container-style u-inner-container-layout u-opacity u-opacity-95 u-sidenav">
              <div class="u-inner-container-layout u-sidenav-overflow">
                ...
                <ul class="u-align-left u-nav u-popupmenu-items u-unstyled u-nav-2">
                  ...
                  <li class="u-nav-item"><a class="u-button-style u-nav-link" href="#">View Student</a>
                  </li>
                  <li class="u-nav-item"><a class="u-button-style u-nav-link" href="#">View Course</a>
                  </li>
                  <li class="u-nav-item"><a class="u-button-style u-nav-link" href="#">View Author</a>
                  </li>
                </ul>
              </div>
            </div>
