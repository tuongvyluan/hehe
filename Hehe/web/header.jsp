          ...
          <div class="u-custom-menu u-nav-container" style="color: #EEE">
            <div class="right-nav">
              <ul class="u-nav u-unstyled u-nav-1">
                <li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="home.jsp" style="padding: 10px 20px;">Home</a>
                </li>
