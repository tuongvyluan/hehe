            ...
            <div class="footer-gray">
                <div class="footer-custom">
                    <div class="footer-lists">
                        ...
                        <div class="footer-list-wrap">
                            <h6 class="ftr-hdr">About Hehe</h6>
                            <ul class="ftr-links-sub">
                                <li><a href="/asp/aboutus/default-asp/_/posters.htm" rel="nofollow">About us</a></li>
                                <li><a href="http://corporate.art.com/careers" rel="nofollow">Terms of use</a></li>
                        ...
                        <!--/.footer-list-wrap-->
                        <div class="footer-list-wrap">
                            <h6 class="ftr-hdr">Study</h6>
                            <ul class="ftr-links-sub">
                                <li><a href="http://www.art.fr" rel="nofollow">Training</a></li>
                                <li><a href="https://www.art.co.uk" rel="nofollow">Practice</a></li>
                                <li><a href="http://www.art.fr" rel="nofollow">Certificate</a></li>
                            </ul>
                        </div>
                        <!--/.footer-list-wrap-->
                    </div>
